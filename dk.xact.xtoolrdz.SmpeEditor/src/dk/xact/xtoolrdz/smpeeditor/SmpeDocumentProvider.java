...
public class SmpeDocumentProvider extends FileDocumentProvider {
	...
	protected IDocument createDocument(Object element) throws CoreException {
		...
		if (document != null) {
			...
			IDocumentPartitioner partitioner = new FastPartitioner(
					new SmpePartitionScanner(), new String[] {
							SmpePartitionScanner.SMPE_TAG,
							SmpePartitionScanner.SMPE_COMMENT });
