...
public class SmpeTagScanner extends RuleBasedScanner {

	public SmpeTagScanner(ColorManager manager) {
		IToken string = new Token(new TextAttribute(
				manager.getColor(ISmpeColorConstants.STRING)));
		...
		rules[1] = new WhitespaceRule(new SmpeWhitespaceDetector());
