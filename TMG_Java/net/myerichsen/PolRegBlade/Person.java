 ...
 */
public class Person {
	private KendteFornavne kf = KendteFornavne.getListe();
	...
	/**
	 * Opdater properties, når køn sættes, f.eks. fra hovedperson eller
	 * ægtefælle
	 * 
	 * @param koen
	 *            the koen to set
	...
	public void setKoen(final Koen koen) {
		...
		kf.add(new Fornavn(this.navn, this.koen));
	}

	/**
	 * Hvis navn findes i properties, sættes kønnet herfra
	 * 
	 * @param navn
	 *            the navn to set
	 */
