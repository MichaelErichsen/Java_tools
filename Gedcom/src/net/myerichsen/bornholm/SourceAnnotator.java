	...
	public void process(JCas aJCas) throws AnalysisEngineProcessException {
		...
		for (Pattern mPattern : mPatterns) {
			...
			if (matcher.find(pos)) {
				...
				annotation
						.setTitle("Bornholmske Skifteprotokoller. 1681 - 1845.");
				annotation.setAuthor("John G. Christensen");
				annotation.setURI(new StringArray(aJCas, 1));
				annotation.setURI(0, "http://www.byholmvej3.dk/");
