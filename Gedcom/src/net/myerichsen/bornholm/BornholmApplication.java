 ...
 *          </ol>
 */
public class BornholmApplication {
	/**
	 * Main program.
	 * 
	 * @param args
		...
		try {
			...
			if (args.length == 2) {
				...
				taeDescriptor = new File(
						"C:\\Workspaces\\Uimaworkspace\\Gedcom\\desc\\Annotators\\Bornholm\\AggregateProbateAnnotator.xml");
				inputDir = new File(
						"C:\\Users\\Michael\\Documents\\UIMA\\Bornholm");
				validArgs = true;
			}
