...
public class PolReg2Ged {
	...
	private void gemGedcomFil() throws PolRegException {
		...
		try {
			System.out.println(getAGedcomFil().toString());
			System.out.println(getAGedcomFil().getRegisterBlade().toString());
			System.out.println(getAGedcomFil().getRegisterBlade().get(0).toString());
			System.out.println(getAGedcomFil().getRegisterBlade().get(0)
			.getHovedPerson().toString());
			System.out.println(getAGedcomFil().getRegisterBlade().get(0)
		...
		if (fc.showSaveDialog(getJFrame()) == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				getAGedcomFil().udskriv(gedcomFileName);
					...
					JOptionPane
							.showMessageDialog(
									...
									"PolReg2Ged,\n"
											...
											+ "hvordan adresser skal gemmes i GEDCOM-filen for at passe\n"
											+ "til din egen opsætning\n\n"
