 ...
 * @generated */
public class AssocIndivType_Type extends Annotation_Type {
  /** @generated */
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (AssocIndivType_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = AssocIndivType_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new AssocIndivType(addr, AssocIndivType_Type.this);
  			   AssocIndivType_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new AssocIndivType(addr, AssocIndivType_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = AssocIndivType.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("net.myerichsen.gedcom.AssocIndivType");
  /** @generated */
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public AssocIndivType_Type(JCas jcas, Type casType) {
    super(jcas, casType);
  ...
  public String getAssociation(int addr) {
      ...
      jcas.throwFeatMissing("association", "net.myerichsen.gedcom.AssocIndivType");
  ...
  public int getCitation(int addr) {
      ...
      jcas.throwFeatMissing("citation", "net.myerichsen.gedcom.AssocIndivType");
...
protected FSGenerator getFSGenerator() {return fsGenerator;}
  ...
  public int getLink(int addr) {
      ...
      jcas.throwFeatMissing("link", "net.myerichsen.gedcom.AssocIndivType");
    return ll_cas.ll_getRefValue(addr, casFeatCode_link);
  }
  /** @generated */ 
  public int getNote(int addr) {
        if (featOkTst && casFeat_note == null)
      jcas.throwFeatMissing("note", "net.myerichsen.gedcom.AssocIndivType");
