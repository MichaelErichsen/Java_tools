 ...
 * @generated */
public class EvidenceType_Type extends Annotation_Type {
  /** @generated */
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (EvidenceType_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = EvidenceType_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new EvidenceType(addr, EvidenceType_Type.this);
  			   EvidenceType_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new EvidenceType(addr, EvidenceType_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = EvidenceType.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("net.myerichsen.gedcom.EvidenceType");
  /** @generated */
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public EvidenceType_Type(JCas jcas, Type casType) {
    super(jcas, casType);
  ...
  public int getCitation(int addr) {
      ...
      jcas.throwFeatMissing("citation", "net.myerichsen.gedcom.EvidenceType");
