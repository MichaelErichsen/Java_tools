 ...
 * @generated */
public class WifeMothType_Type extends Annotation_Type {
  /** @generated */
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (WifeMothType_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = WifeMothType_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new WifeMothType(addr, WifeMothType_Type.this);
  			   WifeMothType_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new WifeMothType(addr, WifeMothType_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = WifeMothType.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("net.myerichsen.gedcom.WifeMothType");
  /** @generated */
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public WifeMothType_Type(JCas jcas, Type casType) {
    super(jcas, casType);
  ...
  public int getFamilyNbr(int addr) {
      ...
      jcas.throwFeatMissing("familyNbr", "net.myerichsen.gedcom.WifeMothType");
...
protected FSGenerator getFSGenerator() {return fsGenerator;}
  ...
  public int getLink(int addr) {
      ...
      jcas.throwFeatMissing("link", "net.myerichsen.gedcom.WifeMothType");
