 ...
 * </ol>
 */
public class HelsebyApplication {
  /**
   * Main program.
   * 
   * @param args
  ...
  public static void main(String[] args) {
    try {
      ...
      if (args.length == 2) {
		...
		taeDescriptor = new File("C:\\Users\\Michael\\uima\\workspace\\Gedcom\\desc\\Annotators\\Helseby\\AggregateProbateAnnotator.xml");
//		taeDescriptor = new File("C:\\Documents and Settings\\michael.XACT_DOMAIN\\IBM\\rationalsdp\\workspace\\Gedcom\\desc\\Annotators\\AureliaAggregateProbateAnnotator.xml");
		inputDir = new File("C:\\Users\\Michael\\Documents\\UIMA\\Helseby");
