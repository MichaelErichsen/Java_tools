  ...
  public static void main(String[] args) {
    try {
      ...
      if (args.length == 2) {
		...
		taeDescriptor = new File("C:\\Users\\Michael\\uima\\workspace\\Gedcom\\desc\\Annotators\\Aurelia\\AggregateProbateAnnotator.xml");
//		taeDescriptor = new File("C:\\Documents and Settings\\michael.XACT_DOMAIN\\IBM\\rationalsdp\\workspace\\Gedcom\\desc\\Annotators\\Aurelia\\AggregateProbateAnnotator.xml");
		inputDir = new File("C:\\Users\\Michael\\Documents\\UIMA\\Aurelia");
