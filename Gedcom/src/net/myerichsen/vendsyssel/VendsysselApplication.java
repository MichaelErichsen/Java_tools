 ...
 *          <p>
 *          An application that reads probate extracts from files, sends them
 *          though an Analysis Engine, and stores the result in a Derby
 *          database.
 *          <p>
 *          The application takes two arguments:
 *          <ol type="1">
 *          <li>The path to an XML descriptor for the Analysis Engine to be
 *          executed</li>
 *          <li>An input directory containing files to be processed</li>
 *          </ol>
 */
public class VendsysselApplication {
	/**
	 * Main program.
	 * 
	 * @param args
		...
		try {
			...
			if (args.length == 2) {
				...
				taeDescriptor = new File(
						"C:\\Workspaces\\Uimaworkspace\\Gedcom\\desc\\Annotators\\Vendsyssel\\AggregateProbateAnnotator.xml");
				inputDir = new File(
						"C:\\Users\\Michael\\Documents\\UIMA\\vendsysselshistorie");
				validArgs = true;
			}
